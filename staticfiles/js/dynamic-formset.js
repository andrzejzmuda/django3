;(function($) {
    $.fn.formset = function(opts)
    {
        ...
        if ($$.length) {
            ...
            addButton.click(function() {
                ...
                // document.querySelectorAll("select[name*='-product']").classList.add('form-control'); //FIXME: perhaps redundant
                return false;
            });
        }
    ...
    $.fn.formset.defaults = {
        prefix: 'orderitems_set',                  // The form prefix for your django formset
        formTemplate: null,              // The jQuery selection cloned to generate new form instances
        addText: '<i style="width: 5%; height: 5%" class="fas fa-plus-square"></i>',          // Text for the add link
